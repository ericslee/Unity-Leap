...
namespace Leap {
	...
	//Leap coordinates are in cm, so the .05f scaling factor means 1cm of hand motion = .05m scene motion
	public static class UnityVectorExtension
	{
		public static Vector3 InputScale = new Vector3(0.05f, 0.05f, 0.05f);
